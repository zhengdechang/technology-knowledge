...
module.exports = {
  ...
  themeConfig: {
    ...
    repo: "zhengdechang/frontend-knowledge", // 导航栏右侧生成Github链接
    ...
    //   '图标地址2'
    // ],
    rightMenuBar: false, //是否显示右侧文章大纲栏。设置为false或屏宽小于1300px时，文章大纲将与左侧侧边栏混合在一起。 (注：在屏宽小于1300px下无论如何都不显示右侧文章大纲栏。)
    ...
    author: {
      ...
      name: "devin", // 必需
      href: "https://github.com/zhengdechang", // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo: "devin | MIT License", // 博客版权信息，支持a标签
    },
  },
  plugins: [
    // 插件
